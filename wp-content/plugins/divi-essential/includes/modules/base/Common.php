...
class Common {
    ...
    public static function apply_bg_css( $render_slug, $context, $color, $use_color_gradient, $gradient, $css_property ) {
        ...
        $bg_stops = $context->props[$color['color_slug']."_gradient_stops"];
        $bg_stops = implode(",",explode("|",$bg_stops));
        $bg_stops_tablet = $context->props[$color['color_slug']."_gradient_stops_tablet"];
        $bg_stops_tablet = implode(",",explode("|",$bg_stops_tablet));
        $bg_stops_phone = $context->props[$color['color_slug']."_gradient_stops_phone"];
