...
*/
  function cww_companion_enqueue_repeater_scripts() {
    wp_enqueue_script( 'cww-companion-repeater-script', CWW_COMP_URL . '/inc/customizer/controllers/repeater-controller/repeater-script.js',array( 'jquery','jquery-ui-sortable'));
    wp_enqueue_style('cww-companion-repeater-style',CWW_COMP_URL . '/inc/customizer/controllers/repeater-controller/repeater-style.css');

}
add_action( 'customize_controls_enqueue_scripts', 'cww_companion_enqueue_repeater_scripts');

/**
* Repeater customizer
*/
add_action( 'customize_register', 'cww_companion_repeaters_customize_register' );
function cww_companion_repeaters_customize_register( $wp_customize ) {
    
    require CWW_COMP_PATH. '/inc/customizer/controllers/repeater-controller/repeater-class.php';
...
* Repeater Sanitize
*/
function cww_companion_sanitize_repeater($input){      
 ...
 * @since 1.0.0
 */
 function cww_companion_icons_array(){
    $icon_list_raw = 
    ...
    $icon_list = explode( ", " , $icon_list_raw);
    return $icon_list;
 }
 ...
 *
 */
 function cww_companion_social_icons_arrays(){
