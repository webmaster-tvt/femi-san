 ...
 * Require class file
 */
require CWW_COMP_PATH . '/inc/customizer/controllers/page-editor/class/class-customizer-page-editor.php';
...
function customizer_editor() {
	...
	<div id="wp-editor-widget-container" style="display: none;">
		...
		<div class="editor">
			...
			?>
			<p><a href="javascript:WPEditorWidget.updateWidgetAndCloseEditor(true);" class="button button-primary"><?php _e( 'Save and close', 'cww-portfolio' ); ?></a></p>
		</div>
	</div>
	<?php
}
