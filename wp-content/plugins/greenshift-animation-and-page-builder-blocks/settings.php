			...
			<div class="wrap gspb_welcome_div_container">
				...
				<div class="gs-padd">
					...
					<div style="text-align:left; padding-top:30px; border-top:1px solid #eee;">
						...
						<div class="gridrows">
							<div><a href="https://youtu.be/Pvaqjz16QHk" target="_blank"><?php esc_html_e("Layout Options - start here", 'greenshift'); ?></a></div>
