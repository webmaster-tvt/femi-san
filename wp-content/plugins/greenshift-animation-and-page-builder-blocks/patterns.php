...
register_block_pattern_category(
    'greenshiftelements',
    array( 'label' => __( 'Greenshift Elements', 'greenshift' ) )
);
...
register_block_pattern(
    ...
    array(
        'title'       => __( 'Button Style', 'greenshift' ),
        'categories' => array('greenshiftelements'),
		'keywords' => array('button', 'cta'),
		'description' => _x( 'button with secondary label and icon', 'Block pattern description', 'greenshift' ),
...
register_block_pattern(
    'greenshift/gridfour',
    array(
        'title'       => __( 'Container grid 4 items', 'greenshift' ),
        'categories' => array('greenshiftelements'),
        'blockTypes'    => array( 'greenshift-blocks/container' ),
		'keywords' => array('container', 'grid'),
		'description' => _x( 'CSS grid with 4 items', 'Block pattern description', 'greenshift' ),
...
register_block_pattern(
    'greenshift/ctablock',
    array(
        'title'       => __( 'CTA simple banner', 'greenshift' ),
        'categories' => array('greenshiftelements'),
        'blockTypes'    => array( 'greenshift-blocks/container' ),
		'keywords' => array('container', 'grid'),
		'description' => _x( 'CTA banner block', 'Block pattern description', 'greenshift' ),
...
register_block_pattern(
    'greenshift/rowfull',
    array(
        'title'       => __( 'Full width Row', 'greenshift' ),
        'categories' => array('greenshiftelements'),
        'blockTypes'    => array( 'greenshift-blocks/row' ),
		'keywords' => array('container', 'row'),
		'description' => _x( 'Full width Row with background and title', 'Block pattern description', 'greenshift' ),
